...
bale_image = face_recognition.load_image_file("bale.jpg")
...
print("Is the unknown face a picture of Bale? {}".format(results[0]))
print("Is the unknown face a picture of Messi ? {}".format(results[1]))
